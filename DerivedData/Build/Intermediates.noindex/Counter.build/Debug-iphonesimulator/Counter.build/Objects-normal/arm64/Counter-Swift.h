...
#ifndef COUNTER_SWIFT_H
#define COUNTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Counter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Counter10CounterApp")
@interface CounterApp : UIResponder <UIApplicationDelegate>
...
@class UIWindow;
SWIFT_CLASS("_TtC7Counter13SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC7Counter14ViewController")
